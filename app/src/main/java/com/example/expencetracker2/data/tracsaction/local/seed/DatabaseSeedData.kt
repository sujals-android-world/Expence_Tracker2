...
object DatabaseSeedData {
    ...
    val REGULAR_CATEGORIES = listOf(
        ...
        SubCategoryEntity(id = 453, masterCategoryId = 4, name = "Repairs", iconName = "ic_repairs", colorHex = "#607D8B", isDefault = true),
        ...
        SubCategoryEntity(id = 751, masterCategoryId = 7, name = "Subscribe", iconName = "ic_subscriptions", colorHex = "#D81B60", isDefault = true),
